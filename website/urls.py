...
urlpatterns = [
    ...
    path('study-abroad-student-placement', StudyAbroadPlacementPageView.as_view(), name='study_abroad_placement_page'),
    path('study-abroad/process-workflow', StudyAbroadWorkFlowPageView.as_view(), name='study_abroad_workflow_page'),
